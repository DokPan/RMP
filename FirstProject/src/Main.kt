...
//
//    // Вывод на консоль
//    print("Hello World!") // без переноса строки
//    println("Hello World!") // с переносом строки
//
//    // Ввод с консоли
...
//    println(i)
//
//    println(3 shl 3) // 11 << 3 = 11000, 3*2 ^ 3
//    println(16 shr 2) // 1100 >> 2 = 11, 12 // 2 ^ 2
//
//    // and, or, xor, !, inv / not
//
//    // &&, ||, !
...
//    }
    ...
    if (1 in arr) { // элемент есть в массиве
        ...
        if (1 !in arr) { // элемента нет в массиве
        }
    ...
    var table : Array<Array<Int>> = Array(5, {Array(2, {0})}) // 5x2
    table[0][0] = 1
